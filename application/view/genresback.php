						...
						<div class="browse-agile-w3ls general-w3ls">
							...
							<div class="browse-inner">
							   ...
							   <div class="col-md-2 w3l-movie-gride-agile">
										 <a href="<?php echo base_url('index.php/start');?><?php echo base_url('index.php/start/');?><?=  $page->href ?>" class="hvr-shutter-out-horizontal"><img src="<?php echo base_url();?>images/<?=  $page->src ?>" title="album-name" alt=" " />

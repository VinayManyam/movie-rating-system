				...
				<div id="owl-demo" class="owl-carousel owl-theme">
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							...
							<a href="<?php echo base_url('index.php/start/');?><?=  $page->href ?>?id=<?=  $page->id ?>" class="hvr-shutter-out-horizontal"><img src="<?php echo base_url();?>images/<?=  $page->src ?>" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="<?php echo base_url('index.php/start/');?>?id=<?=  $page->id ?>?id=<?=  $page->id ?>"><?=  $page->name ?></a></h6>							
								</div>
				...
				<div id="myTabContent" class="tab-content">
					...
					<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								...
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="<?php echo base_url('index.php/start/');?><?=  $page->href ?>?id=<?=  $page->id ?>"></a><?=  $page->name ?></h6>							
									</div>
									<div class="mid-2 agile_mid_2_home">
					...
					<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
						...
						<div class="col-md-2 w3l-movie-gride-agile">
							...
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="<?php echo base_url('index.php/start/');?><?=  $page->href ?>?id=<?=  $page->id ?>"><?=  $page->name ?></a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
									<p>&nbsp;Count:<?= $tel=getCountByProductId(connect(),$page->id  );?></p>
									                           <input value="<?= getRatingByProductId(connect(), $page->id ) ?>" type="number" class="rating" min=0 max=5 step=0.1 data-size="xs" data-stars="5" productId=<?=  $page->id ?>>
					     ...
					     <?php endforeach; ?>	
					       ...
					       <?php foreach ($feature as $page ) : ?>
							...
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								...
								<div class="mid-2 agile_mid_2_home">
									<p>&nbsp;Count:<?= getCountByProductId(connect(),$page->id  );?></p>
									                               <input value="<?= getRatingByProductId(connect(),$page->id ); ?>" type="number" class="rating" min=0 max=5 step=0.1 data-size="xs" data-stars="5" productId=<?=  $page->id ?>>	
...
<!-- Latest-tv-series -->
						...
						<li>
							<div class="agile_tv_series_grid">
								...
								<div class="col-md-6 agile_tv_series_grid_right">
									...
									<p class="fexi_header_para"><span>Date of Release<label>:</label></span> <p>&nbsp;Count:<?= $tel=getCountByProductId(connect(),$page->id  );?></p> </p>
									<p class="fexi_header_para"><span>Genres<label>:</label> </span>
										<a href="<?=  $s->href  ?>?id=<?=  $page->id ?>"><?=  $s->genres  ?></a>
	...
	<!-- pop-up-box -->  
		<script src="<?php echo base_url('index.php/start/');?><?=  $page->href ?>?id=<?=  $page->id ?>js/jquery.magnific-popup.js" type="text/javascript"></script>
	<!--//pop-up-box -->
